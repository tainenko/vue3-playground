import { VNode, FunctionalComponent, ComponentPublicInstance, ComponentOptionsWithObjectProps, ComponentOptionsWithArrayProps, ComponentOptionsWithoutProps, ExtractPropTypes, Component, WritableComputedOptions, ComponentPropsOptions, VNodeProps, ComponentOptionsMixin } from 'vue';
...
interface MountingOptions<Props, Data = {}> {
    data?: () => {} extends Data ? never : Data extends object ? Partial<Data> : never;
    props?: Props;
...
export declare function mount<TestedComponent extends FunctionalComponent<Props>, Props>(originalComponent: TestedComponent, options?: MountingOptions<Props>): VueWrapper<ComponentPublicInstance<Props>>;
export declare function mount<TestedComponent extends ComponentPublicInstance>(originalComponent: {
    new (): TestedComponent;
} & Component, options?: MountingOptions<TestedComponent['$props'], TestedComponent['$data']>): VueWrapper<TestedComponent>;
