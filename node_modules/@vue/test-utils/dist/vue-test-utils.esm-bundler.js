...
/**
 * @vue/test-utils v2.0.0-beta.1
 * (c) 2020 Lachlan Miller
 * Released under the MIT License
 */

import { nextTick, getCurrentInstance, transformVNodeArgs, defineComponent, h, reactive, createApp } from 'vue';
...
function getEventProperties(eventParams) {
    ...
    var eventProperties = __assign(__assign(__assign(__assign({}, systemModifiersMeta), options), { bubbles: meta.bubbles, meta: meta.cancelable, 
...
function findAllVNodes(vnode, selector) {
    ...
    while (nodes.length) {
        ...
        if (node.suspense) {
            ...
            var _a = node.suspense, isResolved = _a.isResolved, fallbackTree = _a.fallbackTree, subTree = _a.subTree;
            if (isResolved) {
...
function mount(originalComponent, options) {
    ...
    var props = reactive(__assign(__assign(__assign({}, options === null || options === void 0 ? void 0 : options.attrs), options === null || options === void 0 ? void 0 : options.props), { ref: MOUNT_COMPONENT_REF }));
